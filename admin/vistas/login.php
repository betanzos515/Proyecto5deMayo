...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600,700" rel="stylesheet">
    <link rel="stylesheet" href="../public/index/reset.min.css">
...
<body>
  ...
  <form method="post" id="frmAcceso">
	...
	<div class="inputGroup inputGroup1">
		...
		<p class="helper helper1">Ingresar Usuario</p>
    ...
    <script src="../public/js/jquery.min.v3.2.1.js"></script>
  <script src='../public/index/js/TweenMax.min.js'></script>
    ...
    <script src="../public/bower_components/SweeAlert2/sweetalert2.min.js"></script>
